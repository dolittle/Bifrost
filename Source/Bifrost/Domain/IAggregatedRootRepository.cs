...
namespace Bifrost.Domain
{
    ...
    /// </summary>
    public interface IAggregatedRootRepository
    {
        /// <summary>
        /// Get an aggregated root by id
        /// </summary>
        /// <returns>An instance of the aggregated root</returns>
        /// <exception cref="MissingAggregatedRootException">Thrown if aggregated root does not exist</exception>
        object Get(Guid id);
    }
	...
	public interface IAggregatedRootRepository<T> : IAggregatedRootRepository
