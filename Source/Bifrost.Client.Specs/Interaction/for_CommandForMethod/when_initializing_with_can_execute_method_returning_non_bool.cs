...
{
    public class when_initializing_with_can_execute_method_returning_non_bool
    {
        ...
        Because of = () => exception = Catch.Exception(() => new CommandForMethod(view_model_mock.Object, "MethodWithoutParameters", "CanExecuteMethodReturningNonBool"));
