...
{
    public class when_initializing_with_method_with_more_than_one_parameter
    {
        ...
        Because of = () => exception = Catch.Exception(() => new CommandForMethod(view_model_mock.Object, "MethodWithTwoParameters"));
