...
namespace Bifrost.Client.Specs.Commands.for_CommandForProxyInterceptor.given
{
    public class all_dependencies
    {
        ...
        protected static Mock<ICanHandleInvocationsFor<ICanProcessCommandProcess, CommandProcessProcessor>> command_process_processor_mock;
        ...
        Establish context = () =>
        {
            ...
            command_process_processor_mock = new Mock<ICanHandleInvocationsFor<ICanProcessCommandProcess,CommandProcessProcessor>>();
        };
    }
}
