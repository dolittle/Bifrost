...
{
    public class when_asking_if_it_can_handle_for_unsupported_type
    {
        ...
        Establish context = () =>
        {
            ...
            method_mock.SetupGet(m=>m.DeclaringType).Returns(typeof(string));
        ...
        It should_respond_with_not_able_to_handle = () => result.ShouldBeFalse();
    }
}
