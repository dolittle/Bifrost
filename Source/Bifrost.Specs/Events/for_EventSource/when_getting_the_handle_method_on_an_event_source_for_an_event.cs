...
namespace Bifrost.Specs.Events.for_EventSource
{
    ...
    public class when_getting_the_handle_method_on_an_event_source_for_an_event : given.two_different_event_source_types_that_handle_different_events
    {
        ...
        Because of = () =>
                         {
                             handled_event_for_first_event_source = event_source.GetHandleMethod(simple_event);
                             //unhandled_event_for_first_event_source = event_source.GetHandleMethod(another_simple_event);

                             handled_event_for_second_event_source = second_event_source.GetHandleMethod(another_simple_event);
                             //unhandled_event_for_second_event_source = second_event_source.GetHandleMethod(simple_event);

                             second_handled_event_for_second_event_source = second_event_source.GetHandleMethod(new SimpleEventWithOneProperty(second_event_source_id));
                         };
