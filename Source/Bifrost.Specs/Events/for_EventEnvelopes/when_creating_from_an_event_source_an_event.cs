...
namespace Bifrost.Specs.Events.for_EventEnvelopes
{
    public class when_creating_from_an_event_source_an_event : given.an_event_envelopes
    {
        ...
        static EventMigrationLevel event_migration_level = 42;
        ...
        Establish context = () =>
        {
            ...
            event_migration_hierarchy_manager.Setup(e => e.GetCurrentMigrationLevelForLogicalEvent(@event.Object.GetType())).Returns(event_migration_level);
        ...
        It should_hold_the_event_migration_level = () => result.MigrationLevel.ShouldEqual(event_migration_level);
