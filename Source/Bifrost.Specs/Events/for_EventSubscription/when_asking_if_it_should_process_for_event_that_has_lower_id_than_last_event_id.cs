...
{
    public class when_asking_if_it_should_process_for_event_that_has_lower_id_than_last_event_id
    {
        ...
        Establish context = () =>
        {
            ...
            event_envelope.SetupGet(e => e.EventId).Returns(1);
        ...
        It should_not_be_able_to_process = () => result.ShouldBeFalse();
    }
}
