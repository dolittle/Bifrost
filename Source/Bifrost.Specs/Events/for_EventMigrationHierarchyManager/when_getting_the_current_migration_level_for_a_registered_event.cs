...
namespace Bifrost.Specs.Events.for_EventMigrationHierarchyManager
{
    public class when_getting_the_current_migration_level_for_a_registered_event : given.an_event_migration_hierarchy_manager_with_two_logical_events
    {
        ...
        Because of = () =>
                         {
                             level_for_event_without_migrations = event_migration_hierarchy_manager.GetCurrentMigrationLevelForLogicalEvent(event_without_migrations);
                             level_for_event_with_migrations = event_migration_hierarchy_manager.GetCurrentMigrationLevelForLogicalEvent(event_with_migrations);
                         };
