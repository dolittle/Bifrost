...
{
    public class when_getting_assemblies_with_dll_assembly_from_file_system_that_should_not_filter_away : given.an_unitialized_assembly_provider
    {
        ...
        It should_return_only_the_assembly_from_the_filesystem = () => result.ShouldContainOnly(assembly);
    }
}