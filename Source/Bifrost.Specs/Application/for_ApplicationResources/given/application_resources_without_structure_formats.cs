...
namespace Bifrost.Specs.Application.for_ApplicationResources.given
{
    public class application_resources_without_structure_formats : all_dependencies
    {
        ...
        protected static Mock<IApplicationStructureConfigurationBuilder> application_structure;

        Establish context = () =>
        {
            application_structure = new Mock<IApplicationStructureConfigurationBuilder>();
