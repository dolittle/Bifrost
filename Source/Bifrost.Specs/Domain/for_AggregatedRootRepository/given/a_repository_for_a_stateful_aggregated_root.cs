...
{
	public class a_repository_for_a_stateful_aggregated_root
	{
		protected static AggregatedRootRepository<SimpleStatefulAggregatedRoot> repository;
		...
		Establish context = () =>
		                    {
								...
								repository = new AggregatedRootRepository<SimpleStatefulAggregatedRoot>(command_context_manager_mock.Object);
