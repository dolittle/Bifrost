...
namespace Bifrost.Specs.Validation.for_ChapterValidationService
{
    ...
    public class when_validating_a_chapter_with_chapter_validator_only : given.a_chapter_validation_service
    {
        ...
        Establish context = () =>
        {
            ...
            chapter_validator_provider_mock.Setup(vp => vp.GetValidatorForTransitionTo<SimpleChapter>(chapter_mock.Object)).Returns(new NullChapterValidator());
