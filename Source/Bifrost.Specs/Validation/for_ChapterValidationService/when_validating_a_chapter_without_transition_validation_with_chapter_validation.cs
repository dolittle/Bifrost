...
namespace Bifrost.Specs.Validation.for_ChapterValidationService
{
    ...
    public class when_validating_a_chapter_without_transition_validation_without_chapter_validation : given.a_chapter_validation_service
    {
        static IEnumerable<ValidationResult> validation_results;
        static Mock<IChapterValidator> chapter_validator_mock;
        static NullChapterValidator null_transition_validator;
        ...
        Establish context = () =>
                                {
                                    ...
                                    null_transition_validator = new NullChapterValidator();
