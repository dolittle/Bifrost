...
namespace Bifrost.Specs.Validation.for_CommandValidationService.given
{
    public class a_command_validation_service : a_command_validator_provider_with_input_and_business_validators
    {
        ...
        protected static Mock<ICommandValidatorProvider> command_validator_service_mock;

        Establish context = () =>
                                {
                                    command_validator_service_mock = new Mock<ICommandValidatorProvider>();
                                    command_validation_service = new CommandValidationService(command_validator_service_mock.Object);
                                };
    }
}