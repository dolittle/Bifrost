...
namespace Bifrost.Specs.Mapping.for_PropertyMapExtensions
{
    public class when_specifying_to_property
    {
        ...
        It should_hold_the_reference_to_the_target_property_in_the_strategy = () => ((TargetPropertyMappingStrategy)map.Strategy).PropertyInfo.ShouldEqual(typeof(Target).GetProperty("SomeProperty"));
    }
}
