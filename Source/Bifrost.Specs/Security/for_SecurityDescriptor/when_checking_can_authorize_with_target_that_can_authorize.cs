...
namespace Bifrost.Specs.Security.for_SecurityDescriptor
{
    ...
    {
        static Mock<ISecurityAction> action_that_can_authorize;
        ...
        {
            action_that_can_authorize = new Mock<ISecurityAction>();
            action_that_can_authorize.Setup(a => a.CanAuthorize(Moq.It.IsAny<object>())).Returns(true);
            ...
            descriptor.AddAction(action_that_can_authorize.Object);
        }
