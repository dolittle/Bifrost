        ...
        Establish context = () =>
                                {
                                    ...
                                    service_locator_mock.Setup(s => s.GetInstance<SagaWithOneChapterProperty>()).Returns(new SagaWithOneChapterProperty());
                                    service_locator_mock.Setup(s => s.GetInstance(typeof (SimpleChapter))).Returns(
                                        simple_chapter);
                                };
