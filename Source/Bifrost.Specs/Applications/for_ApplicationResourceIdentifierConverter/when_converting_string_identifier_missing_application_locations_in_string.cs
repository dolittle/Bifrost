...
namespace Bifrost.Specs.Applications.for_ApplicationResourceIdentifierConverter
{
    ...
    {
        static string string_identifier = $"{application_name}{ApplicationResourceIdentifierConverter.ApplicationSeparator}{ApplicationResourceIdentifierConverter.ApplicationResourceSeparator}Resource";
