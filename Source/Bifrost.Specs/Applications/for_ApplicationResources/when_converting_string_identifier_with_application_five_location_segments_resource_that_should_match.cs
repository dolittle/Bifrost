...
{
    public class when_converting_string_identifier_with_application_five_location_segments_resource_that_should_match : given.application_resources_without_structure_formats
    {
