describe("when getting all elements with viewmodel files sorted with two deep hierarchies", function () {
    ...
    var elements = service.getAllElementsWithViewModelFilesSorted();
