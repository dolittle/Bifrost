...
namespace Bifrost.RavenDB.Specs.for_EntityIdPropertyRegister
{
    ...
    public class when_asking_if_another_property_is_the_id_property : given.an_entity_id_property_register_with_ids_registered
    {
        ...
        Establish context = () =>
                                {
                                    property_to_check = typeof(SimpleEntity).GetProperty("SimpleStringProperty");
                                };
