...
namespace Bifrost.RavenDB.Specs.for_ConceptTypeConverter
{
    ...
    public class when_checking_can_convert_from_a_concept_of_guid : given.a_concept_type_converter
    {
        static bool can_convert;

        Because of = () => can_convert = converter.CanConvertFrom(typeof(given.ConceptAsGuid));
