...
#pragma warning disable 1591 // Xml Comments
        ...
        {
            return FromJson<T>(json, SerializationOptions.Default);
        }

        public T FromJson<T>(string json, ISerializationOptions options)
		{
        ...
        {
            return FromJson(type, json, SerializationOptions.Default);
        }

        public object FromJson(Type type, string json, ISerializationOptions options)
		{
        ...
        public void FromJson(object instance, string json)
        {
            FromJson(instance, json, SerializationOptions.Default);
        }

        public void FromJson(object instance, string json, ISerializationOptions options)
		{
			var serializer = CreateSerializerForDeserialization(options);
			using (var textReader = new StringReader(json))
			{
        ...
        {
            return ToJson(instance, SerializationOptions.Default);
        }

        public string ToJson(object instance, ISerializationOptions options)
		{
        ...
        public Stream ToJsonStream(object instance)
        {
            return ToJsonStream(instance, SerializationOptions.Default);
        }

        public Stream ToJsonStream(object instance, ISerializationOptions options)
        {
