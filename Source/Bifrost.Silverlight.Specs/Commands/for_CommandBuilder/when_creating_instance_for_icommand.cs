...
{
    public class when_creating_instance_for_icommand
    {
        static CommandBuilder<ICommand> builder;
        ...
        Because of = () => builder = new CommandBuilder<ICommand>(new Mock<ICommandCoordinator>().Object, conventions_mock.Object);
