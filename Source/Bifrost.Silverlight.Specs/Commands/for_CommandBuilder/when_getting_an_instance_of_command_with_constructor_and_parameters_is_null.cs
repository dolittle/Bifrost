...
{
    public class when_getting_an_instance_of_command_with_constructor_and_parameters_is_null : given.an_empty_command_builder_for_known_command_with_constructor_parameter
    {
